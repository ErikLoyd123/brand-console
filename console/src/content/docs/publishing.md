...
Once LinkedIn is connected (see **Connect LinkedIn**), the Drafts editor gains a **Publish to LinkedIn** button.
...
If you'd rather not connect LinkedIn at all, or you just want to publish somewhere else, the **Copy to publish** button in the Drafts editor stays available either way. It copies the finished post text to your clipboard so you can paste it wherever you publish from.
...
2. Hit **Copy to publish** in the Drafts editor. It copies the finished text to your clipboard and archives the post in **Published** for your own record.
